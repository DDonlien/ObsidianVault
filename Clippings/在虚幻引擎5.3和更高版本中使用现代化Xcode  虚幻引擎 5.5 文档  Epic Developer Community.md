---
title: "在虚幻引擎5.3和更高版本中使用现代化Xcode | 虚幻引擎 5.5 文档 | Epic Developer Community"
source: "https://dev.epicgames.com/documentation/zh-cn/unreal-engine/using-modern-xcode-in-unreal-engine-5.3-and-newer"
author:
  - "[[Epic Games Developer]]"
published:
created: 2025-01-26
description: "了解UE的Xcode工作流程在UE 5.3和更高版本中的变化。"
tags:
  - "clippings"
---
...
1. 为引擎和项目重新生成你的Xcode项目文件。如果你使用的是UE的源代码版本，请在引擎安装目录中运行 `GenerateProjectFiles.command` 脚本，为UE的源代码重新生成项目文件。你应该在项目目录中看到三个Xcode工作空间文件：
...
![客户端、编辑器、游戏和服务器的单独项目。](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/85a01ac3-5158-4673-ad9c-2d57883b2683/projectsschemesconfigs1.png)

每个目标仅有其支持的构建配置。例如，大多数编辑器不支持测试或发布配置，因此它们在编辑器项目下不可用。

![构建配置](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/64f6cb8d-1122-49a6-87b1-1b966cbc7822/projectsschemesconfigs2.png)

更新的工作空间有大量方案。浏览这些方案时，根据需要使用"筛选器"和"最近"分段来缩小列表范围。

![方案列表](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/55f26dc4-e85d-4808-ad5f-3ce4197a0d51/projectsschemesconfigs3.png)
...
![Xcode工作空间](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/3590cc18-02b0-494e-b5e0-9e676ca26230/perplatformworkspaces1.png)
...
![Xcode中高亮显示的产品/存档按钮](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/d0b9de80-5a91-4294-80f8-6deca2508d82/distribution1.png)
...
![Xcode中列示的Xcode存档](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/a6a117d5-0dda-4714-adaa-d4ab12acd96c/distribution2.png)
...
![分发和验证应用程序按钮](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/6c656025-2f68-44c6-91b1-1e5954f51178/distribution3.png)
...
![存档发布项目](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/0502447b-cfc1-48ec-9326-3cbf8d3024f3/distribution4.png)
...
![](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/be21486a-476a-47ee-ac87-6a0f22e6f4b0/xcodeprojectssettings.png)
...
![Xcode中的团队ID设置](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/b48cdef4-342e-4b3f-b5a3-ac45b7c72326/teamid.png)
...
|  | **Mac** | **IOS** |
| --- | --- | --- |
| **默认.plist（Default .plist）** | 从引擎目录复制的模板。 | UBT生成的模板。 |
| **Xcode .plist修改（Xcode .plist modification）** | 是 | 如果使用UBT生成的模板，则为否 |
